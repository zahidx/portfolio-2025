...
import { db, addDoc, collection } from "../v1-components/firebase";
import Address from "../v1-components/Address";
import { Toast } from "../v1-components/Toast";
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">1212 Main Street, Dhaka City, Bangladesh</p>
              </div>
            </div>
          </div>
        ...
        <div className="flex justify-center items-center">
          ...
          >
            <div className="space-y-2">
              <label htmlFor="v1-name" className="block text-sm font-semibold text-gray-700 dark:text-gray-300">
                Your Name
              </label>
              <input
                type="text"
            ...
            <div className="space-y-2">
              <label htmlFor="v1-email" className="block text-sm font-semibold text-gray-700 dark:text-gray-300">
                Your Email
              </label>
              <input
                type="email"
            ...
            <div className="space-y-2">
              <label htmlFor="v1-subject" className="block text-sm font-semibold text-gray-700 dark:text-gray-300">
                Subject
              </label>
              <input
                type="text"
            ...
            <div className="space-y-2">
              <label htmlFor="v1-message" className="block text-sm font-semibold text-gray-700 dark:text-gray-300">
                Message
              </label>
              <textarea
                id="v1-message"
