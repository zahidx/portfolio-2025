...
import {
  FaRobot, FaTasks, FaShoppingCart, FaFilm, FaBook, FaRocket,
  FaRegClipboard, FaDollarSign, FaUtensils, FaCloudSun, FaNewspaper,
  FaTools, FaPlayCircle, FaImage, FaBookOpen,
} from "react-icons/fa";
import AOS from "aos";
...
const projects = [
  ...
  {
    title: "OrbitX",
    description: "OrbitX allows users to fetch data from the NASA API, providing space-related content, such as images, videos, and articles.",
  ...
  {
    title: "QuizArena",
    description: "QuizArena is an interactive quiz platform using the Trivia API, offering various quiz categories and difficulty levels.",
  ...
  },
  {
    ...
    description: "A weather forecast application that fetches real-time weather data from a weather API. Users can check weather forecasts for different cities.",
  ...
  },
  {
    ...
    description: "The Daily Sunrise is a news website that fetches the latest headlines and articles using a news API.",
  ...
  {
    title: "Utility Pro",
    description: "Utility Pro is a comprehensive toolset web app that integrates 20 different utilities in one platform.",
  ...
  {
    title: "Snap Vault",
    description: "Snap Vault is a high-quality wallpaper storage and sharing platform, similar to Unsplash.",
    icon: <FaImage className="text-6xl text-green-500 dark:text-green-400 mx-auto" />,
    githubLink: "https://github.com/zahidx/snap-vault.git",
    livePreview: "https://snap-vault-u.netlify.app/",
  },
  {
    title: "Tele Craft",
    description: "Tele Craft is an AI-powered storytelling web application that generates engaging and dynamic stories based on user input.",
    icon: <FaBookOpen className="text-6xl text-orange-500 dark:text-orange-400 mx-auto" />,
    githubLink: "https://github.com/your-repo-link",
    livePreview: "https://your-live-preview-link",
  },
  {
    title: "Prime Hub",
    description: "Prime Hub is a subscription-based OTT content platform that offers a seamless streaming experience.",
    icon: <FaPlayCircle className="text-6xl text-purple-500 dark:text-purple-400 mx-auto" />,
    githubLink: "https://github.com/your-repo-link",
    livePreview: "https://your-live-preview-link",
  },
  {
  ...
  },
  {
    ...
    description: "A simple and intuitive to-do list application with features like adding tasks, marking completed tasks, and more.",
        ...
        {projects.map((project, index) => (
          <div
            ...
            className={`
              ...
              transform-gpu hover:scale-105 sm:hover:scale-110 hover:shadow-2xl hover:z-10
