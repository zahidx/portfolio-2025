...
export default function Contact() {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-20 px-8 md:px-36 relative" id="contact">
      ...
      {/* Heading */}
      <h1 className="text-5xl font-extrabold text-center text-indigo-600 dark:text-indigo-400 mb-10 tracking-wide">Get in Touch</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div className="space-y-8 pt-28">
          ...
          <div className="space-y-10">
            <div className="flex items-center">
              <span className="w-5 h-5 flex justify-center items-center bg-indigo-500 text-white rounded-full shadow-md"></span>
              <div className="ml-4">
            ...
            <div className="flex items-center">
              <span className="w-5 h-5 flex justify-center items-center bg-green-500 text-white rounded-full shadow-md"></span>
              <div className="ml-4">
            ...
            <div className="flex items-center">
              <span className="w-5 h-5 flex justify-center items-center bg-red-500 text-white rounded-full shadow-md"></span>
              <div className="ml-4">
        ...
        <div className="flex justify-center items-center py-6 px-4">
          <form
            ...
            className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md hover:shadow-lg transform transition-transform hover:scale-105 space-y-4 w-full max-w-md"
          >
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full p-2 bg-gray-100 dark:bg-gray-700 rounded-lg border border-gray-300 dark:text-gray-50 dark:border-gray-600 focus:ring-indigo-400 transition"
              />
            </div>
            <div className="space-y-2">
              <label
              ...
              <input
                ...
                className="w-full p-2 bg-gray-100 dark:bg-gray-700 dark:text-gray-50 rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-indigo-400 transition"
              />
            </div>
            <div className="space-y-2">
              <label
