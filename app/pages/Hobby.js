...
export default function Hobbies() {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-400 to-[#D1C7FE] dark:bg-gradient-to-r dark:from-blue-900 dark:via-blue-900 dark:to-[#0c0d51] text-gray-50 dark:text-gray-200 pt-28 pb-12 px-8 pl-28 pr-28 overflow-x-hidden">
      ...
      <div
        ref={lineRef}
        className="w-full h-[2px] mx-auto mb-8 animate-line"
      ></div>
  ...
  <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100  transition-transform duration-400 ease-out transform group-hover:scale-105 group-hover:rotate-2 group-hover:translate-y-1 group-hover:shadow-xl group-hover:tracking-wide">
    {hobby.title}
  </h2>
  <p className="mt-2 text-gray-600 dark:text-gray-400  transition-all duration-400 ease-out group-hover:scale-100 group-hover:translate-y-1 group-hover:opacity-80 group-hover:tracking-wide">
    {hobby.description}
  </p>
</div>
