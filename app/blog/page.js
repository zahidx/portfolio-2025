      ...
      <AnimatePresence>
        {showTop && (
          <motion.button
            ...
            data-cursor
            className="fixed bottom-6 right-6 z-50 p-3 rounded-full border border-white/15 bg-[#0a0a1c]/80 backdrop-blur-md text-slate-300 hover:text-white hover:border-fuchsia-400/50 transition-colors"
