...
const Page = () => {
  ...
  return (
    <div className="pt-36 pb-10 min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
    {/* Header Section */}
    <header className="text-center mb-16">
      <motion.h1
        className="text-3xl sm:text-4xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 via-pink-500 to-red-500"
        style={{
      ...
      <motion.p
        className="mt-4 text-base sm:text-lg md:text-xl text-gray-400"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
